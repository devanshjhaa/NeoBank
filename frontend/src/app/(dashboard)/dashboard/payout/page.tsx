          ...
          <div className="p-6 space-y-6">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 ring-1 ring-slate-100 dark:ring-slate-700/50 space-y-3">
              <div className="flex justify-between text-[13px]">
                <span className="text-slate-500 dark:text-slate-400">Bank Account ID</span>
                <span className="font-mono font-semibold text-slate-900 dark:text-white">#{formData.bankAccountId}</span>
              </div>
              <div className="flex justify-between text-[13px]">
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white dark:bg-[#111827] rounded-xl border border-slate-200/80 dark:border-slate-700/50 overflow-hidden">
        <div className="px-5 py-4 border-b border-slate-100 dark:border-slate-700/50">
          ...
          <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">Enter your bank account ID and amount to withdraw</p>
        </div>

        <div className="p-5">
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="bankAccountId" className="text-[13px] font-medium text-slate-700 dark:text-slate-300">Bank Account ID</Label>
              <Input
                id="bankAccountId"
                type="text"
                inputMode="numeric"
              ...
              <p className="text-[11px] text-slate-400 dark:text-slate-500">Your linked bank account identifier</p>
            </div>
