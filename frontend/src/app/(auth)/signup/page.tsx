        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-10 xl:p-14">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-5 text-slate-400 text-base leading-relaxed">
              Join 50,000+ users who manage their money smarter with instant transfers,
              secure wallets, and premium banking features.
            </p>

            <div className="mt-8 flex flex-col gap-4">
              {[
                { label: "No setup fees", desc: "Get started completely free" },
                { label: "2-minute setup", desc: "Quick phone verification" },
                { label: "Bank-grade security", desc: "256-bit encryption" },
              ].map((item) => (
                <div key={item.label} className="flex items-start gap-3">
                  <div className="mt-0.5 h-5 w-5 rounded-full bg-blue-600/20 border border-blue-500/30 grid place-items-center shrink-0">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              &ldquo;NeoBank simplified my daily transactions. Transfers are instant and the
              wallet management is incredibly smooth.&rdquo;
            </p>
            <div className="mt-3 flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 grid place-items-center text-white text-xs font-bold">
                R
              </div>
              <div>
                <p className="text-sm font-medium text-white">Rahul Sharma</p>
                <p className="text-xs text-slate-500">Product Manager, Bangalore</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Get started with your free NeoBank wallet
            </p>
          </div>
